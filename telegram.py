...
def Telegram_end(time):
    minutes = str(time/60)
    requests.get('https://maker.ifttt.com/trigger/Python_Notification/with/key/bXSrizhTgJGwUIACW3-I3qcmIT5SCgmUpf1ELH3Uiex?value1=MP&value2=Code finished!&value3=' + minutes +' minutes')
