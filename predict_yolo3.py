# andreas marxer
# script for predicting bb from pretrained weights only
...
# ----------------------------------- MODEL -----------------------------------
# load yolov3 model
model = load_model('model_yolo3.h5')
...
for i in range(len(y_hat)):
    # decode the output of the network to bounding box and class prediction
    boxes += decode_netout(y_hat[i][0], anchors[i],
                           class_threshold, input_h, input_w)

# correct the sizes of the bounding boxes for the shape of the image
correct_yolo_boxes(boxes, image_h, image_w, input_h, input_w)
# suppress non-maximal boxes and take the next best confident class instead
do_nms(boxes, 0.5)
